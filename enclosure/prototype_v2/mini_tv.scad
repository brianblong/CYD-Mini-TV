// Mini-TV prototype V2. Millimeters. Parts export in their PRINT orientations.
...
// Keep the internal plug envelope and the original fit coupon unchanged.
...
module fit_coupon() {
    ...
    difference() {
        ...
        translate([5,-9,-eps]) cube([cable_connector_wh[0]+2*cable_clearance,cable_connector_wh[1]+2*cable_clearance,back_t+2*eps]);
    }
}
...
echo("V2 body:",[case_w,case_h,case_d],"front glass plane:",board_front_z-glass_above_pcb_front);
